...
export const BRAND_META = {
  plagueatlas: {
    name:        "PlagueAtlas",
    headline:    "History's Deadliest Epidemics",
    tagline:     "Interactive epidemic & disease history map — 1,500 years of data",
    description: "Explore and compare the deadliest epidemics and pandemics in human history. Interactive 3D globe, animated death counters, and data-driven statistics.",
  ...
  deathvault: {
    ...
    description: "Classified archive of history's deadliest events. Pandemics, world wars, famines, and nuclear disasters visualised on an interactive globe. 813M+ deaths across 16 events.",
