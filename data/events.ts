...
El brote no terminó de forma limpia. La peste regresó en oleadas recurrentes durante aproximadamente dos siglos, con brotes documentados en 558, 573, 586, 599 y más allá, encontrando cada resurgimiento nuevas poblaciones con inmunidad reducida. La pandemia remitió finalmente hacia el año 750 d. C., posiblemente porque las poblaciones de ratas que sostenían el ciclo pulga-peste colapsaron o porque los supervivientes habían desarrollado inmunidad parcial. Para entonces, el Imperio Bizantino había perdido de forma permanente su posición como potencia dominante del Mediterráneo, y el escenario estaba preparado para el rápido auge del islam por territorios devastados y despoblados por siglos de peste.`,
    ...
    seoTitle: "Plague of Justinian Death Toll: 15–100 Million Deaths by Source (541–549)",
    seoTitleEs: "Muertes de la Plaga de Justiniano: 15–100 millones según la fuente (541–549)",
    seoDescription: "How many people died from the Plague of Justinian? Classic estimates reach 25–50 million (up to 100 million across recurrences), while recent revisionist studies argue for far lower mortality. Death toll compared by source.",
    seoDescriptionEs: "¿Cuántas personas murieron por la Plaga de Justiniano? Las estimaciones clásicas alcanzan los 25–50 millones (hasta 100 millones con las recurrencias), mientras que estudios revisionistas recientes defienden una mortalidad mucho menor. Cifras comparadas por fuente.",
    seoTagline: "Plague of Justinian death toll estimates and casualties by source — from revisionist lower-bound figures to classic estimates of 25–50 million dead in the 6th-century Byzantine world.",
    seoTaglineEs: "Estimaciones del número de muertes y víctimas de la Plaga de Justiniano por fuente — desde cifras revisionistas de límite inferior hasta estimaciones clásicas de 25–50 millones de muertos en el mundo bizantino del siglo VI.",
    tollBySource: [
      { source: "Classic estimate (traditional historiography)", sourceEs: "Estimación clásica (historiografía tradicional)", figure: "25–50 million", figureEs: "25–50 millones", note: "Long-standing figure, often cited as up to half the population of the affected regions.", noteEs: "Cifra tradicional, citada a menudo como hasta la mitad de la población de las regiones afectadas." },
      { source: "Encyclopaedia Britannica", sourceEs: "Encyclopaedia Britannica", figure: "~25–50 million", figureEs: "~25–50 millones", note: "Reference figure for the first pandemic and its recurring waves through ~750 CE.", noteEs: "Cifra de referencia para la primera pandemia y sus oleadas recurrentes hasta ~750 d. C." },
      { source: "Upper-bound (recurrences to 750 CE)", sourceEs: "Límite superior (recurrencias hasta 750 d. C.)", figure: "up to ~100 million", figureEs: "hasta ~100 millones", note: "Highest historiographic estimates summing two centuries of recurring outbreaks.", noteEs: "Estimaciones historiográficas más altas que suman dos siglos de brotes recurrentes." },
      { source: "Revisionist studies (Mordechai et al., 2019)", sourceEs: "Estudios revisionistas (Mordechai et al., 2019)", figure: "far lower / disputed", figureEs: "muy inferior / en disputa", note: "Recent analyses of papyri, coinage and pollen argue the plague was less demographically catastrophic than long believed.", noteEs: "Análisis recientes de papiros, monedas y polen sostienen que la plaga fue menos catastrófica demográficamente de lo que se creía." },
    ],
...
La Peste Negra no terminó en 1353. La peste continuó regresando a Europa en oleadas durante tres siglos — la Gran Peste de Londres de 1665 fue una de sus últimas grandes visitaciones europeas. El mecanismo de persistencia era el reservorio de poblaciones de ratas infectadas por toda Eurasia, a partir del cual podían desencadenarse nuevos brotes. No fue hasta finales del siglo XIX, con la identificación de la bacteria por parte de Alexandre Yersin en 1894 y la posterior comprensión de que las pulgas de las ratas eran el vector, cuando la humanidad entendió por fin contra qué había estado luchando. Hoy en día, la peste todavía existe en reservorios de roedores en partes del Oeste americano, Asia Central y África, pero los antibióticos la hacen fácilmente tratable cuando se identifica a tiempo.`,
    ...
    seoTitle: "Black Death Death Toll: 75–200 Million Deaths by Source (1347–1353)",
    seoTitleEs: "Muertes de la Peste Negra: 75–200 millones según la fuente (1347–1353)",
    seoDescription: "How many people died from the Black Death? Estimates range from 75 million to 200 million worldwide, killing 30–60% of Europe. Death toll and casualties compared by source (Britannica, OWID, Benedictow).",
    seoDescriptionEs: "¿Cuántas personas murieron por la Peste Negra? Las estimaciones van de 75 a 200 millones en todo el mundo, matando al 30–60 % de Europa. Cifras de muertes comparadas por fuente (Britannica, OWID, Benedictow).",
    seoTagline: "Black Death death toll estimates and casualties by source — from 75 million to 200 million dead worldwide between 1347 and 1353, wiping out 30–60% of Europe's population.",
    seoTaglineEs: "Estimaciones del número de muertes y víctimas de la Peste Negra por fuente — de 75 a 200 millones de muertos en todo el mundo entre 1347 y 1353, eliminando entre el 30 y el 60 % de la población de Europa.",
    tollBySource: [
      { source: "Encyclopaedia Britannica", sourceEs: "Encyclopaedia Britannica", figure: "75–200 million", figureEs: "75–200 millones", note: "Standard reference range for the global toll of the 1347–1353 pandemic.", noteEs: "Rango de referencia estándar para el balance global de la pandemia de 1347–1353." },
      { source: "Our World in Data", sourceEs: "Our World in Data", figure: "~75–200 million", figureEs: "~75–200 millones", note: "Cites the wide scholarly range; notes Europe lost an estimated 30–60% of its population.", noteEs: "Cita el amplio rango académico; señala que Europa perdió un estimado del 30–60 % de su población." },
      { source: "Ole J. Benedictow (historian)", sourceEs: "Ole J. Benedictow (historiador)", figure: "~50 million in Europe", figureEs: "~50 millones en Europa", note: "Influential demographic study estimating ~60% mortality across Europe alone.", noteEs: "Estudio demográfico influyente que estima ~60 % de mortalidad solo en Europa." },
      { source: "WHO / historical consensus", sourceEs: "OMS / consenso histórico", figure: "~25 million in Europe", figureEs: "~25 millones en Europa", note: "Lower-bound European figure cited in older public-health summaries (~one-third of Europe).", noteEs: "Cifra europea de límite inferior citada en resúmenes de salud pública más antiguos (~un tercio de Europa)." },
    ],
    dataReliabilityLevel: "moderate",
...
La Gripe Española terminó gradualmente durante 1919 y principios de 1920, a medida que el virus mutaba hacia cepas menos letales y se desarrollaba la inmunidad de grupo en las poblaciones supervivientes. Dejó una profunda huella en la historia demográfica: la esperanza de vida humana media en Estados Unidos cayó 12 años entre 1917 y 1918. Sus lecciones sobre la preparación frente a pandemias, los peligros de censurar la información sobre brotes y la vulnerabilidad de las poblaciones de alta densidad ante los patógenos respiratorios determinaron directamente cómo las instituciones de salud pública responderían más tarde a la COVID-19, más de un siglo después.`,
    ...
    seoTitle: "Spanish Flu Death Toll: 17–100 Million Deaths by Source (1918–1920)",
    seoTitleEs: "Muertes de la Gripe Española: 17–100 millones según la fuente (1918–1920)",
    seoDescription: "How many people died from the 1918 Spanish Flu? Estimates range from 17 million (early figures) to 50–100 million (modern excess-mortality studies). Death toll and casualties compared by source (CDC, WHO, Johnson & Mueller).",
    seoDescriptionEs: "¿Cuántas personas murieron por la Gripe Española de 1918? Las estimaciones van de 17 millones (cifras iniciales) a 50–100 millones (estudios modernos de exceso de mortalidad). Cifras comparadas por fuente (CDC, OMS, Johnson y Mueller).",
    seoTagline: "Spanish Flu death toll estimates and casualties by source — from an early figure of ~17 million to modern estimates of 50–100 million dead, infecting about a third of humanity in 1918–1920.",
    seoTaglineEs: "Estimaciones del número de muertes y víctimas de la Gripe Española por fuente — desde una cifra inicial de ~17 millones hasta estimaciones modernas de 50–100 millones de muertos, infectando a cerca de un tercio de la humanidad en 1918–1920.",
    tollBySource: [
      { source: "Early / contemporary estimates", sourceEs: "Estimaciones iniciales / contemporáneas", figure: "~17–21 million", figureEs: "~17–21 millones", note: "Original 20th-century figures, now considered a significant undercount.", noteEs: "Cifras originales del siglo XX, hoy consideradas una subestimación significativa." },
      { source: "CDC", sourceEs: "CDC", figure: "~50 million", figureEs: "~50 millones", note: "Commonly cited modern estimate; about 675,000 deaths in the United States.", noteEs: "Estimación moderna citada con frecuencia; unas 675.000 muertes en Estados Unidos." },
      { source: "Johnson & Mueller (2002)", sourceEs: "Johnson y Mueller (2002)", figure: "~50–100 million", figureEs: "~50–100 millones", note: "Peer-reviewed reassessment widely used as the upper-bound scholarly range.", noteEs: "Reevaluación revisada por pares ampliamente usada como rango académico de límite superior." },
      { source: "WHO", sourceEs: "OMS", figure: "20–50 million", figureEs: "20–50 millones", note: "Range cited in WHO pandemic-history materials.", noteEs: "Rango citado en los materiales de la OMS sobre la historia de las pandemias." },
    ],
    dataReliabilityLevel: "moderate",
...
La guerra terminó con la rendición incondicional de Alemania el 8 de mayo de 1945 (Día de la Victoria en Europa) y de Japón el 2 de septiembre de 1945 (Día de la Victoria sobre Japón), tras los bombardeos atómicos de Hiroshima y Nagasaki — el primer y único uso de armas nucleares en combate. El orden de la posguerra produjo las Naciones Unidas, los Juicios de Núremberg (que establecieron la responsabilidad penal individual por crímenes de guerra), la reconstrucción de Europa con el Plan Marshall y la división del mundo durante la Guerra Fría entre las esferas estadounidense y soviética. Ningún acontecimiento de la historia ha remodelado de forma más completa la política mundial, el derecho internacional y la concepción humana de los límites de la guerra.`,
    ...
    seoTitle: "World War II Death Toll: 70–85 Million Deaths by Source (1939–1945)",
    seoTitleEs: "Muertes de la Segunda Guerra Mundial: 70–85 millones según la fuente (1939–1945)",
    seoDescription: "How many people died in World War II? Estimates range from 70 to 85 million — roughly 21M military and 50M+ civilian deaths. Death toll and casualties compared by source (National WWII Museum, Britannica, OWID).",
    seoDescriptionEs: "¿Cuántas personas murieron en la Segunda Guerra Mundial? Las estimaciones van de 70 a 85 millones — unos 21M militares y más de 50M civiles. Cifras de muertes comparadas por fuente (National WWII Museum, Britannica, OWID).",
    seoTagline: "World War II death toll estimates and casualties by source — from 70 million to 85 million dead between 1939 and 1945, the deadliest conflict in human history.",
    seoTaglineEs: "Estimaciones del número de muertes y víctimas de la Segunda Guerra Mundial por fuente — de 70 a 85 millones de muertos entre 1939 y 1945, el conflicto más mortífero de la historia humana.",
    tollBySource: [
      { source: "The National WWII Museum", sourceEs: "The National WWII Museum", figure: "~70–85 million", figureEs: "~70–85 millones", note: "Total deaths; about 15 million battle deaths and 45 million civilian deaths cited.", noteEs: "Muertes totales; se citan unos 15 millones de muertes en combate y 45 millones de muertes civiles." },
      { source: "Encyclopaedia Britannica", sourceEs: "Encyclopaedia Britannica", figure: "40–50 million+ to ~85 million", figureEs: "de 40–50 millones+ a ~85 millones", note: "Notes wide variation; total commonly placed at 70–85 million when famine and disease are included.", noteEs: "Señala una amplia variación; el total se sitúa habitualmente en 70–85 millones al incluir hambruna y enfermedad." },
      { source: "Our World in Data", sourceEs: "Our World in Data", figure: "~70–85 million", figureEs: "~70–85 millones", note: "Soviet Union ~27 million and China ~15–20 million were the largest national tolls.", noteEs: "La Unión Soviética (~27 millones) y China (~15–20 millones) fueron los mayores balances nacionales." },
      { source: "Military-only deaths", sourceEs: "Solo muertes militares", figure: "~21–25 million", figureEs: "~21–25 millones", note: "Combatant deaths across all theaters, excluding civilian and famine deaths.", noteEs: "Muertes de combatientes en todos los escenarios, excluyendo muertes civiles y por hambruna." },
    ],
    dataReliabilityLevel: "high",
...
A mediados del siglo XIV, el imperio se fragmentó en estados sucesores: la dinastía Yuan en China, el Ilkanato en Persia, el Kanato de Chagatai en Asia Central y la Horda de Oro por Rusia. Cada uno siguió trayectorias diferentes, algunos integrándose con las culturas locales y convirtiéndose al islam, otros manteniendo las tradiciones mongolas. La dinastía Ming expulsó a los Yuan de China en 1368, y los demás kanatos se disolvieron o fueron absorbidos gradualmente. Pero el daño demográfico y cultural fue permanente: civilizaciones enteras — la sofisticada cultura urbana de Jorasán, las sociedades agrícolas del valle de Ferganá — nunca se recuperaron del todo.`,
    ...
    seoTitle: "Mongol Conquests Death Toll: 30–60 Million Deaths by Source (1206–1368)",
    seoTitleEs: "Muertes de las Conquistas Mongolas: 30–60 millones según la fuente (1206–1368)",
    seoDescription: "How many people did the Mongols kill? Estimates range from 30 million to 40–60 million — possibly ~10% of the world's 13th-century population. Death toll and casualties compared by source (Britannica, McEvedy, Diamond).",
    seoDescriptionEs: "¿A cuántas personas mataron los mongoles? Las estimaciones van de 30 millones a 40–60 millones — posiblemente ~10 % de la población mundial del siglo XIII. Cifras comparadas por fuente (Britannica, McEvedy, Diamond).",
    seoTagline: "Mongol Conquests death toll estimates and casualties by source — from 30 million to as many as 40–60 million dead between 1206 and 1368, perhaps a tenth of humanity at the time.",
    seoTaglineEs: "Estimaciones del número de muertes y víctimas de las Conquistas Mongolas por fuente — de 30 millones a hasta 40–60 millones de muertos entre 1206 y 1368, quizá una décima parte de la humanidad de entonces.",
    tollBySource: [
      { source: "Encyclopaedia Britannica / common estimate", sourceEs: "Encyclopaedia Britannica / estimación común", figure: "~30–40 million", figureEs: "~30–40 millones", note: "Frequently cited central range for total deaths across the conquests.", noteEs: "Rango central citado con frecuencia para el total de muertes a lo largo de las conquistas." },
      { source: "Upper-bound estimates", sourceEs: "Estimaciones de límite superior", figure: "up to ~60 million", figureEs: "hasta ~60 millones", note: "Highest figures, sometimes cited as ~11% of the world population of the era.", noteEs: "Cifras más altas, citadas a veces como ~11 % de la población mundial de la época." },
      { source: "China alone (census decline)", sourceEs: "Solo China (descenso censal)", figure: "~30–40 million", figureEs: "~30–40 millones", note: "Drop inferred from Chinese census records before and after the Yuan conquest.", noteEs: "Descenso inferido de los registros censales chinos antes y después de la conquista Yuan." },
      { source: "Persia / Iran & Iraq", sourceEs: "Persia / Irán e Irak", figure: "~50–75% of population", figureEs: "~50–75 % de la población", note: "Regional demographic collapse cited by historians for the Ilkhanate territories.", noteEs: "Colapso demográfico regional citado por historiadores para los territorios del Ilkanato." },
    ],
